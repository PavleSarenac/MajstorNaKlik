...
<head>
    ...
    <title>MajstorNaKlik - Ulogovan majstor</title>
</head>
    ...
    <div class="container-fluid">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="majstorPregledProfila.html">Moj profil</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <form action="">
                ...
                <div class="row">
                    <div class="col"></div>
                    <div class="col text-italic text-center">
