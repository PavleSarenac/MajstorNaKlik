...
<head>
    ...
    <title>MajstorNaKlik - Pregled profila majstora (registrovani korisnik)</title>
</head>
...
<body>
    <div class="container-fluid">
        ...
        <div class="row text-italic text-center">
            <h1><strong>Pregled profila majstora (od strane registrovanog korisnika):</strong></h1>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-3 offset-sm-2">
                <button class="btn"
                    ...
                    onclick="prijavi()">Prijavi majstora</button>
            </div>
            <div class="offset-sm-4 col-sm-3">
                <button class="btn" style="align-items: center; border: 2px solid black; background-color: black; "><a
